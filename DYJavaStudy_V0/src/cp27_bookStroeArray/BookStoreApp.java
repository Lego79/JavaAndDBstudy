...
public class BookStoreApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n==== printBookStore() ====");
		//printBookStore() : 북스토어 전체 도서 정보
		bs.printBookstore();
		
		System.out.println("\n==== printBookStoreByCategory() ====");
		//분야별 도서정보
		
//		System.out.println("\n ---- comic ----");
//		bs.printBookStoreByCategory();
		...
		System.out.println("979-11-90277-42-6");
		String isbn = "979-11-90277-42-6";
		bs.printBookByIsbn(isbn);
		
		System.out.println("979-11-90277-42-7");
